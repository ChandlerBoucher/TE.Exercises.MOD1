...
namespace Exercises
{
    public partial class Exercises
    {
        ...
        {
            foreach (KeyValuePair<string, int> quant in remoteWarehouse)
            {
                string keysPlz = quant.Key;
                if (mainWarehouse.ContainsKey(keysPlz))
                {
                    mainWarehouse[keysPlz] = mainWarehouse[keysPlz] + remoteWarehouse[keysPlz];
                }
                else
                {
                    mainWarehouse[keysPlz] = quant.Value;
                }
            }
